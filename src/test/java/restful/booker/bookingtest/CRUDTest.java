package restful.booker.bookingtest;
...
public class CRUDTest extends TestBase {
    ...
    public static String firstname = "Anki" + TestUtils.getRandomValue();
    public static String lastname = "patel" + TestUtils.getRandomValue();
    public static Integer totalprice = Integer.valueOf(TestUtils.getRandomValue());
